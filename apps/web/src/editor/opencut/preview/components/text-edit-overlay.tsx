...
import type { TextElement } from "@opencut/timeline";
...
import { buildTransformFromParams } from "@opencut/rendering";
import { resolveTextLayout } from "@opencut/text/primitives";
import {
	...
	return (
		...
		>
			<div
				...
				tabIndex={0}
				role="textbox"
				aria-label={tTimeline("ariaEditText")}
