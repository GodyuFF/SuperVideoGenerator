...
import { useTransformHandles } from "@opencut/preview/hooks/use-transform-handles";
...
import type { OnSnapLinesChange } from "@opencut/preview/hooks/use-preview-interaction";
import {
	BoundingBoxOutline,
	CornerHandle,
	EdgeHandle,
