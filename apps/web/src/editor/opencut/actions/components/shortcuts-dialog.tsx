...
} from "@opencut/actions/use-keyboard-shortcuts-help";
...
import {
	translateActionCategory,
	translateActionDescription,
	useOpencutT,
} from "@opencut/i18n/useOpencutT";
						...
						{categories.map((category) => (
							<div key={category} className="flex flex-col gap-1">
								<h3 className="text-muted-foreground text-xs font-medium tracking-wide uppercase">
									{translateActionCategory(category)}
								</h3>
...
function ShortcutItem({
	...
	const description = translateActionDescription(shortcut.action);
