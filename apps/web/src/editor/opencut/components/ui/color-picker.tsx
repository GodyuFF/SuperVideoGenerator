			...
			<header className="border-b flex justify-between items-center pb-2 px-2">
				<Select defaultValue="custom">
					<SelectTrigger variant="outline">
						<SelectValue placeholder={tProperties("colorSelectMode")} />
					</SelectTrigger>
					<SelectContent position="popper">
						<SelectItem value="custom">{tProperties("colorCustom")}</SelectItem>
						<SelectItem value="saved">{tProperties("colorSaved")}</SelectItem>
					</SelectContent>
				</Select>
				<div>
