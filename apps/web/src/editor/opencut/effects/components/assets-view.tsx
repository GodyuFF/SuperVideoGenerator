...
import { effectsRegistry, EFFECT_TARGET_ELEMENT_TYPES } from "@opencut/effects";
import { effectPreviewService } from "@opencut/services/renderer/effect-preview";
import { useEditor } from "@opencut/editor/use-editor";
import { buildEffectElement } from "@opencut/timeline/element-utils";
...
export function EffectsView() {
	...
	return (
		<PanelView title={tAssets("tabs.effects")}>
