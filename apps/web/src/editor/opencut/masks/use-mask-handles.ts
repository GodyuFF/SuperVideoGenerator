...
import { getMaskDefinition } from "@opencut/masks";
import { appendPointToFreeformPathMask } from "@opencut/masks/freeform/definition";
import {
	getVisibleElementsWithBounds,
	type ElementBounds,
} from "@opencut/preview/element-bounds";
import {
	SNAP_THRESHOLD_SCREEN_PIXELS,
	type SnapLine,
} from "@opencut/preview/preview-snap";
import type { SelectedMaskPointSelection } from "@opencut/selection/editor-selection";
import type { Mask, MaskHandleId, MaskInteractionResult } from "@opencut/masks/types";
import type { MaskableElement } from "@opencut/timeline";
import { isMaskableElement } from "@opencut/timeline/element-utils";
