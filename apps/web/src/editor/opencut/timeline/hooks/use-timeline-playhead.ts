...
import { timelineTimeToPixels } from "@opencut/timeline";
import {
	PlayheadController,
	type PlayheadConfig,
} from "@opencut/timeline/controllers/playhead-controller";
...
export function useTimelinePlayhead({
	...
	const config: PlayheadConfig = {
		...
		getSceneTracks: () => editor.scenes.getActiveSceneOrNull()?.tracks ?? null,
		getSceneBookmarks: () => editor.scenes.getActiveSceneOrNull()?.bookmarks ?? [],
