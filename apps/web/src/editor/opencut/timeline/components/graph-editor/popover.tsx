...
import { Popover, PopoverContent } from "@opencut/components/ui/popover";
...
import { getBezierPoint } from "@opencut/animation/bezier";
import type { NormalizedCubicBezier } from "@opencut/animation/types";
				...
				<Tabs variant="underline" defaultValue="presets" className="flex flex-col gap-2">
					...
					<TabsContent value="presets" className="px-3 pb-0">
						<ExpandableGrid
							...
							expandAriaLabel={tDialogs("graphExpand")}
						>
					...
					<TabsContent value="saved" className="px-3">
						<div className="grid grid-cols-3 gap-1">
							...
							>
								...
								<span className="text-[10px] leading-tight">{tDialogs("graphSavePreset")}</span>
							</button>
						</div>
					</TabsContent>
				</Tabs>
