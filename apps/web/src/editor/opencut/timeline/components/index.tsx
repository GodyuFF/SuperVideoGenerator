...
import { OcShapesIcon, OcVideoIcon } from "@opencut/components/icons";
import {
	ContextMenu,
	ContextMenuContent,
	ContextMenuItem,
...
import { useTimelineZoom } from "@opencut/timeline/hooks/use-timeline-zoom";
import {
	useCallback,
	useEffect,
	useMemo,
...
import type { ElementDragView, DropTarget } from "@opencut/timeline";
import { TimelineTrackContent } from "./timeline-track";
import { TimelinePlayhead } from "./timeline-playhead";
import { SelectionBox } from "@opencut/selection/selection-box";
import { useBoxSelect } from "@opencut/selection/hooks/use-box-select";
import { SnapIndicator } from "./snap-indicator";
import type { SnapPoint } from "@opencut/timeline/snapping";
import type { TimelineTrack } from "@opencut/timeline";
import {
...
import { useElementInteraction } from "@opencut/timeline/hooks/element/use-element-interaction";
import {
	canTrackHaveAudio,
	canTrackBeHidden,
	getTimelineZoomMin,
...
import { useTimelineSeek } from "@opencut/timeline/hooks/use-timeline-seek";
import { useTimelineDragDrop } from "@opencut/timeline/hooks/use-timeline-drag-drop";
import { TimelineRuler } from "./timeline-ruler";
import {
	TimelineBookmarksRow,
	useBookmarkDrag,
} from "@opencut/timeline/bookmarks/index";
import { useEdgeAutoScroll } from "@opencut/timeline/hooks/use-edge-auto-scroll";
import { useInitialScrollBottom } from "@opencut/timeline/hooks/use-initial-scroll-bottom";
import { useTimelineResize } from "@opencut/timeline/hooks/use-timeline-resize";
import { useTimelineStore } from "@opencut/timeline/timeline-store";
import { useEditor } from "@opencut/editor/use-editor";
import { useScrollPosition } from "@opencut/timeline/hooks/use-scroll-position";
import { useTimelinePlayhead } from "@opencut/timeline/hooks/use-timeline-playhead";
...
export function Timeline() {
	...
	return (
		<section
			...
			data-svf-region="timeline"
			{...dragProps}
			aria-label={tTimeline("ariaTimeline")}
		>
			<TimelineToolbar
				zoomLevel={zoomLevel}
				minZoom={minZoomLevel}
