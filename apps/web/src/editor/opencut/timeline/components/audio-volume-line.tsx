...
import {
	getDbFromLinePos,
	getLinePosFromDb,
} from "@opencut/timeline/audio-display";
import { VOLUME_DB_MAX, VOLUME_DB_MIN } from "@opencut/timeline/audio-constants";
import { getElementVolume, hasAnimatedVolume } from "@opencut/timeline/audio-state";
import type { AudioElement } from "@opencut/timeline/types";
import {
	clamp,
