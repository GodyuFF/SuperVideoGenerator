...
import { TIMELINE_DRAG_THRESHOLD_PX } from "@opencut/timeline/components/interaction";
import { getMouseTimeFromClientX } from "@opencut/timeline/drag-utils";
import {
	buildTimelineSnapPoints,
	getTimelineSnapThresholdInTicks,
	resolveTimelineSnap,
	type SnapPoint,
} from "@opencut/timeline/snapping";
import { getBookmarkSnapPoints } from "../snap-source";
import { getElementEdgeSnapPoints } from "@opencut/timeline/element-snap-source";
import { getPlayheadSnapPoints } from "@opencut/timeline/playhead-snap-source";
import { getAnimationKeyframeSnapPointsForTimeline } from "@opencut/timeline/animation-snap-points";
import type { Bookmark } from "@opencut/timeline";
import { roundFrameTime, type MediaTime, ZERO_MEDIA_TIME } from "@opencut/wasm";
