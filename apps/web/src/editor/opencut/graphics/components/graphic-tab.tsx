...
import { useElementPlayhead } from "@opencut/components/editor/panels/properties/hooks/use-element-playhead";
import {
	useKeyframedParamProperty,
	type KeyframedParamPropertyResult,
} from "@opencut/components/editor/panels/properties/hooks/use-keyframed-param-property";
import type { ParamDefinition, ParamValues } from "@opencut/params";
import type { GraphicElement } from "@opencut/timeline";
import { graphicsRegistry, registerDefaultGraphics, resolveGraphicElementParamsAtTime } from "@opencut/graphics";
...
import { PropertyParamField } from "@opencut/components/editor/panels/properties/components/property-param-field";
...
function StrokeSection({
	...
	return (
		...
		>
			...
			>
				<SectionTitle>{tProperties("stroke")}</SectionTitle>
			</SectionHeader>
			<SectionContent
