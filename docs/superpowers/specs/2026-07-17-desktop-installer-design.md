...
> 用户发版与安装说明：[`../../desktop-packaging.md`](../reference/desktop-packaging.md)  
...
docs/superpowers/reference/desktop-packaging.md      # 用户向：安装、首次打开绕过系统拦截、发版步骤（实现时同步）
```
...
- `docs/superpowers/reference/code-design-plan.md` §2 仓库结构：packaging / workflow
- `docs/superpowers/reference/product-plan.md`：桌面分发与自动更新简述
- `apps/desktop/README.md`：开发壳 vs 安装包
- [`docs/superpowers/reference/desktop-packaging.md`](../reference/desktop-packaging.md)：发版步骤、首次打开绕过说明、双版本升级验收、可选签名附录
