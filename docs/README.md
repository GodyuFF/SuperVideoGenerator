...
| 文档 | 说明 |
|------|------|
| [产品概览](product-overview.md) / [EN](product-overview.en.md) | 定位、核心能力、交互范式 |
| [快速开始](getting-started.md) / [EN](getting-started.en.md) | 安装 / 启动（中文首次使用见用户手册） |
| [用户手册](user-guide/README.md) | 从零到成片、配置、对话、看板、剪辑、模式与 FAQ（中文） |
